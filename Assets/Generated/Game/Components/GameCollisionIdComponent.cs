...
public partial class GameEntity {
    ...
    public Components.CollisionId collisionId { get { return (Components.CollisionId)GetComponent(GameComponentsLookup.CollisionId); } }
    ...
    public GameEntity AddCollisionId(int newValue) {
        ...
        var component = (Components.CollisionId)CreateComponent(index, typeof(Components.CollisionId));
