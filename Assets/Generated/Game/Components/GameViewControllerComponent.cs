...
public partial class GameEntity {
    ...
    public Components.ViewControllerComponent viewController { get { return (Components.ViewControllerComponent)GetComponent(GameComponentsLookup.ViewController); } }
    public View.IView ViewController { get { return viewController.Value; } }
    public bool hasViewController { get { return HasComponent(GameComponentsLookup.ViewController); } }

    public GameEntity AddViewController(View.IView newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Components.ViewControllerComponent)CreateComponent(index, typeof(Components.ViewControllerComponent));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewController(View.IView newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Components.ViewControllerComponent)CreateComponent(index, typeof(Components.ViewControllerComponent));
        component.Value = newValue;
...
public partial class GameEntity {
    ...
    public void AddViewController(View.IView newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Components.ViewControllerComponent)CreateComponent(index, typeof(Components.ViewControllerComponent));
        component.Value = newValue;
        AddComponent(index, component);
    ...
    public void ReplaceViewController(View.IView newValue) {
        var index = GameComponentsLookup.ViewController;
        var component = (Components.ViewControllerComponent)CreateComponent(index, typeof(Components.ViewControllerComponent));
        component.Value = newValue;
        ReplaceComponent(index, component);
